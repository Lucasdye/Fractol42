...
/*   Updated: 2023/07/17 11:09:11 by lbouguet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define ERROR_MSG1 "Error, try this : [prgname] [fractalname] [JuliaVar].\n"
# define ERROR_MSG2 "Fractals are \"Julia\" \"Mandelbrot\" \"BurningShip\".\n"
# define ERROR_MSG3 "Julia variants are \"neuron\" \"brain\" \"galaxy\".\n"
# define ERROR_MSG4 "No Mandelbrot nor Burninship variant exists.\n"
...
unsigned int		render_color_arlequin(int iteration, t_fractal *f);
